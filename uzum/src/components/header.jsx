  ...
  return (
    <header className="relative">
      ...
      <div className="flex lg:hidden items-center justify-between px-3 pt-2">
        ...
        >
          <FiMapPin />
          <p className="font-normal text-[15px]">Toshkent</p>
          <p className="mt-1">
            <IoIosArrowDown />
          </p>
        </div>
        <p onClick={toggleModal} className="text-[14px] text-gray-600">
          yetkazib beriladigan shahar
        </p>
      </div>
      <div className="p-3 flex lg:hidden relative">
        <input
          type="text"
          placeholder="Mahsulotlar va turkumlar izlash"
          className="p-1 pl-8 border-2 border-gray-200 bg-gray-200 rounded-[5px] w-full outline-hidden"
        />
        <p className="absolute top-5 ml-2 text-black">
          <CiSearch size={20} />
        </p>
      </div>
      {openModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div
            ...
            onClick={toggleModal}
          ></div>
          <div className="relative lg:z-50 lg:w-full lg:max-w-2xl bg-white p-3 lg:rounded-xl lg:shadow-lg lg:mx-4: w-[100%] h-[100%] lg:h-auto">
      ...
      <div className="hidden lg:flex big-container m-auto justify-between">
